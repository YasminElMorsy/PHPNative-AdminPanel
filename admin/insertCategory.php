                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 ">
                            ...
                            <div class="panel panel-primary text-center no-boder bg-color-blue input-lg">
                                <form onsubmit="return flag;" method="post" class="form-group form-inline">
                                    <div id="ca" class="form-group">
                                        <label for="insert">insertCategoryName:</label>
                                        <input type="text" name="name" class="form-control" id="insert">
                                        <span id='check'>
                                    </span>
                                    <script>
                                        onload=function(){
                                           ...
                                           $("#insert").blur(function(event) {
                                                ...
                                                if(this.value.match(pat))
                                                    ...
                                                    {
                                                        $('#check').css('color', 'red');
                                                        $('#check').text('insertOnlyCharacters');
                                                        $('#insert').focus();
                                                        flag=false;
                                                    }
                                            }); 
